async function loadCMS() {
    try {
        const r = await fetch("/cms/content.json", {
            cache: "no-store"
        });
        if (!r.ok) return null;
        return await r.json();
...
const CONTENT = {
    en: {
        ...
        trust: {
            title: "Trusted by finance teams who prefer control over reaction"
        },
        what: {
            kicker: "What We Do",
            title: "What We Do",
        ...
        benefits: {
            ...
            b1t: "Control",
            b1: "Avoid last-minute changes by defining scope, data, and responsibilities early.",
            b2t: "Continuity",
            b2: "Keep your accounting system — no ERP replacement required.",
            b3t: "Compliance",
            b3: "Structured data readiness: mandatory fields + ASP transmission alignment."
        },
        how: {
            kicker: "How it works",
            ...
            s1t: "Assess",
            s1: "Assess your exposure and document scope.",
            s2t: "Validate",
            s2: "Validate mandatory VAT data fields for structured readiness.",
            s3t: "Align",
            s3: "Align with accredited ASP requirements and create a controlled roadmap."
        },
        int: {
            kicker: "Integrations",
            ...
            i1t: "ERP systems",
            i1: "ERP-neutral approach. Keep your system and map outputs.",
            i2t: "Accredited ASP",
            i2: "Handoff format alignment for transmission workflows.",
            i3t: "CMS ready",
            i3: "Override all copy via /cms/content.json (Strapi, Contentful, Sanity, WP).",
            i4t: "CRM / forms",
            i4: "Connect the form to any endpoint (HubSpot / Zoho / custom)."
        },
        price: {
            kicker: "Pricing",
            title: "Pricing",
            ...
            b1: "Start",
            p1t: "Readiness Call",
            p1d: "A 20-minute call to frame scope, timeline, and next steps.",
            p1l1: "Scope questions",
            p1l2: "High-level readiness guidance",
            p1l3: "Next-step plan",
            b2: "Popular",
            p2t: "Readiness Assessment",
            p2d: "Structured review of mandatory fields and document scope.",
            p2l1: "Mandatory field checklist",
            p2l2: "Document scope mapping",
            p2l3: "Risk + gap summary",
            b3: "Scale",
            p3t: "Implementation Roadmap",
            p3d: "Controlled plan aligned with accredited ASP requirements.",
            p3l1: "ERP → ASP flow mapping",
            p3l2: "Roles & controls",
            p3l3: "Phased rollout plan"
        },
        faq: {
            kicker: "FAQ",
            title: "FAQ",
    ...
    ru: {
        ...
        trust: {
            title: "Для финансовых команд, которые предпочитают контроль вместо реакции"
        },
        what: {
        ...
        benefits: {
            ...
            b1t: "Контроль",
            b1: "Уйти от авралов: заранее определить объём, данные и ответственность.",
            b2t: "Непрерывность",
            b2: "Сохраняете учетную систему — менять ERP не нужно.",
            b3t: "Соответствие",
            b3: "Готовность данных: обязательные поля + передача через ASP."
        },
        how: {
            ...
            s1t: "Оценка",
            s1: "Оценить влияние и перечень документов.",
            s2t: "Проверка",
            s2: "Проверить обязательные VAT-поля для структурной готовности.",
            s3t: "Согласование",
            s3: "Согласовать требования ASP и сформировать дорожную карту."
        },
        int: {
            kicker: "Интеграция",
            ...
            i1t: "ERP системы",
            i1: "ERP-нейтрально: сохраняете систему и сопоставляете вывод.",
            i2t: "Аккредитованные ASP",
            i2: "Сопоставление формата и процессов передачи.",
            i3t: "CMS готово",
            i3: "Все тексты можно заменить через /cms/content.json (Strapi, Contentful, Sanity, WP).",
            i4t: "CRM / формы",
            i4: "Подключение формы к любому endpoint (HubSpot / Zoho / custom)."
        },
        price: {
            kicker: "Цены",
            title: "Цены",
            ...
            b1: "Старт",
            p1t: "Звонок готовности",
            p1d: "20 минут: объём, сроки, следующие шаги.",
            p1l1: "Вопросы по объёму",
            p1l2: "Общая оценка готовности",
            p1l3: "План следующих шагов",
            b2: "Популярно",
            p2t: "Оценка готовности",
            p2d: "Структурная проверка обязательных полей и объёма документов.",
            p2l1: "Чек-лист обязательных полей",
            p2l2: "Карта документов",
            p2l3: "Риски и гэпы",
            b3: "Масштаб",
            p3t: "Дорожная карта",
            p3d: "Управляемый план с учетом требований аккредитованных ASP.",
            p3l1: "Карта потока ERP → ASP",
            p3l2: "Роли и контроли",
            p3l3: "Поэтапное внедрение"
        },
        faq: {
            kicker: "FAQ",
            title: "Вопросы",
        ...
        form: {
            ...
            erp: "Текущая ERP-система",
            submit: "Запросить анализ →"
        },
        footerLegal: {
